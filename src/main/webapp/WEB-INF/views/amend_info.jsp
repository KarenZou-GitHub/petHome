        ...
        <div  class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-6 col-md-6">
                    <input type="text" class="form-control" id="inputName" placeholder="不可更改！" readonly>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="inputHead" class="col-sm-2 col-md-2 control-label">头像</label>
                <div class="col-sm-6 col-md-6">
                    <input type="text" class="form-control" id="inputHead" placeholder="改头像" />
                </div>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
    ...
    function initData() {
        ...
        document.getElementById("inputHead").value = (user.head)?(user.head):"";
        document.getElementById("inputPassword").value = user.password;
        document.getElementById("inputPhoneNumber").value = (user.phoneNumber)?(user.phoneNumber):"";
        document.getElementById("address").value = (user.address)?(user.address):"";
    }
    function startUpdate() {
        ...
        user.head = document.getElementById("inputHead").value;
