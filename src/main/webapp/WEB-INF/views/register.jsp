            ...
            <div  class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-6 col-md-6">
                        <input type="text" class="form-control" id="inputName" placeholder="请输入用户名称！"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="postcodes" class="col-sm-2 col-md-2 control-label">头像</label>
                    <div class="col-sm-6 col-md-6">
                        <input type="text" class="form-control" id="inputHead" placeholder="头像等等再做" />
                    </div>
                </div>
